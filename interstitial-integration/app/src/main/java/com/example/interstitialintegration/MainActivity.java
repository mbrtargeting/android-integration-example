...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Yieldlove.setApplicationName(getApplicationContext(), "appDfpTestID5"); // <-- put here your application name
...
//        });
    ...
    public void btnInterstitialClick(View view) throws ContextException {
        try {
            ...
            ad.load("int", new YieldloveInterstitialAdListener(){  // <-- put here your adslot name
